...
//    private static final String USER_RESOURCE_NAME = "default";
...
//     */
//    @RequestMapping("/user")
//    @SentinelResource(value = SentinelRuleConfig.RESOURCE_NAME,  fallback = "fallbackHandleForGetUser",
//            /*exceptionsToIgnore = {ArithmeticException.class},*/
//            /*blockHandlerClass = User.class,*/ blockHandler = "blockHandlerForGetUser")
//    public Result getUser(String id) {
//        return Result.ok("xushu");
//    }
//
//    public Result fallbackHandleForGetUser(String id,Throwable e) {
//        e.printStackTrace();
//        return  Result.error("异常处理");
//    }
//
//    /**
//     * 注意：
...
//     * @return
//     */
//    public Result blockHandlerForGetUser(String id, BlockException ex) {
//        ex.printStackTrace();
//        return  Result.error("流控！！");
//    }
//
////
